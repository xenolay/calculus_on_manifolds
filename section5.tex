...
\end{equation}が成り立つ．より象徴的な略記として，特に$p$を省いても問題にならない場合に
\begin{equation}
...
特に上の例で$f$として座標関数を取れば，ベクトル場のときとよく似た，しかし異なる座標変換則を得るに至る；
...
\begin{equation}
d\omega_p \coloneqq \sum_{1 \leq i_1 < i_2 < \dots i_k \leq n} \left(df^y_{i_1,i_2,\dots,i_n}\right)_p \wedge \left( dy^{i_1} \right)_p \wedge \dots \wedge \left( dy^{i_k} \right)_p
\end{equation}
によって定める．
\end{defi}
